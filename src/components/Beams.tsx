...
const CanvasWrapper = ({ children, onReady }: { children: React.ReactNode; onReady?: () => void }) => (
  <Canvas
    dpr={[1, 2]}
    frameloop="always"
    className="beams-container"
    onCreated={() => {
      // Canvas + WebGL context is ready, first frame will render next tick
      if (onReady) {
...
const Beams = ({
  ...
  return (
    <CanvasWrapper onReady={onReady}>
      ...
      <color attach="background" args={['#AFBEBD']} />
